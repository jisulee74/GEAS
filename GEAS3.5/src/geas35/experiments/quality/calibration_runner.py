...
def run_model_threshold_calibration(
    *,
    ...
    application_artifact_path = save_quality_model_application(
        model,
        model_dir,
        thresholds=threshold_result.best_threshold,
        observation_columns=columns,
        metadata={
    ...
    return ModelThresholdCalibrationResult(
        ...
        application_artifact_path=str(application_artifact_path),
    )
...
def _aggregate_threshold_payload(
    ...
    return {
        ...
        "models": {
            result.model_name: {
                **_threshold_payload(result.threshold_result),
                "application_artifact_path": result.application_artifact_path,
            }
