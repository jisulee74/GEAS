...
class DbConfig:
    ...
    main_cols: str = (
        ...
        "cont_heater_run, cont_cooler_run, cont_co2_run, cont_3way1_vol, cont_3way2_vol, "
        "cont_pump1_run, cont_pump2_run, cont_fan_run"
    )
    ...
    def from_env(cls) -> "DbConfig":
        return cls(
            ...
            main_cols=os.getenv("MAIN_COLS", "reg_date, in_temp, in_hum, in_co2, out_temp, out_hum, out_winddirec, out_windsp, out_light, out_rain, cont_skyl_vol, cont_skyr_vol, cont_cur_vol, cont_kwcur_vol, cont_heater_run, cont_cooler_run, cont_co2_run, cont_3way1_vol, cont_3way2_vol, cont_pump1_run, cont_pump2_run, cont_fan_run"),
